...
@variable(model, Pˢᴳ²_1[1:T])        # generation of SGs , buses:2,3,4,5,27,30.  Include strategic and non-strategic players
...
μᵐⁱⁿˢᴳ²⁷_1=JuMP.value.(μᵐⁱⁿˢᴳ²⁷_1)
μᵐⁱⁿˢᴳ²⁷_2=JuMP.value.(μᵐⁱⁿˢᴳ²⁷_2)
μᵐᵃˣˢᴳ²⁷_2=JuMP.value.(μᵐᵃˣˢᴳ²⁷_2)
μᵐᵃˣˢᴳ²⁷_1=JuMP.value.(μᵐᵃˣˢᴳ²⁷_1)
plot(μᵐⁱⁿˢᴳ²⁷_1)
plot!(μᵐⁱⁿˢᴳ²⁷_2)
plot(μᵐᵃˣˢᴳ²⁷_1)
plot!(μᵐᵃˣˢᴳ²⁷_2)

σˢʰˢᴳ²⁷_1=JuMP.value.(σˢʰˢᴳ²⁷_1)
σˢʰˢᴳ²⁷_2=JuMP.value.(σˢʰˢᴳ²⁷_2)
σˢᵗˢᴳ²⁷_1=JuMP.value.(σˢᵗˢᴳ²⁷_1)
σˢᵗˢᴳ²⁷_2=JuMP.value.(σˢᵗˢᴳ²⁷_2)
plot(σˢʰˢᴳ²⁷_1)
plot!(σˢʰˢᴳ²⁷_2)
plot(σˢᵗˢᴳ²⁷_1)
plot!(σˢᵗˢᴳ²⁷_2)
...
matwrite("mu_min_27_1.mat", Dict("mu_min_27_1" => μᵐⁱⁿˢᴳ²⁷_1))
matwrite("mu_min_27_2.mat", Dict("mu_min_27_2" => μᵐⁱⁿˢᴳ²⁷_2))
matwrite("mu_max_27_1.mat", Dict("mu_max_27_1" => μᵐᵃˣˢᴳ²⁷_1))
matwrite("mu_max_27_2.mat", Dict("mu_max_27_2" => μᵐᵃˣˢᴳ²⁷_2))

matwrite("ro_sh_27_1.mat", Dict("ro_sh_27_1" => σˢʰˢᴳ²⁷_1))
matwrite("ro_sh_27_2.mat", Dict("ro_sh_27_2" => σˢʰˢᴳ²⁷_2))
matwrite("ro_st_27_1.mat", Dict("ro_st_27_1" => σˢᵗˢᴳ²⁷_1))
matwrite("ro_st_27_2.mat", Dict("ro_st_27_2" => σˢᵗˢᴳ²⁷_2))
...
@constraint(model, Oⁿˡ[3] +sum( kᴬˢ_26_g1[T]*A[T,13] +kᴬˢ_29_g1[T]*A[T,14] +kᴬˢ_30_g1[T]*A[T,15]) -K_g[5,k]*λ_F[n,T] -Pˢᴳₘₐₓ[3]*μᵐᵃˣˢᴳ⁴_1[T] +Pˢᴳₘᵢₙ[3]*μᵐⁱⁿˢᴳ⁴_1[T] +Kˢᵗ[3]*σˢᵗˢᴳ⁴_1[T] -Kˢʰ[3]*σˢʰˢᴳ⁴_1[T]+ ψᵐᵃˣˢᴳ⁴_1[T] >=0)
...
for t in 1:T-1                                                                                                                                                                                  # dual constraints for UC, when t<=T-1
    ...
    @constraint(model, Oⁿˡ[3] +sum( kᴬˢ_26_g1[t]*A[t,13] +kᴬˢ_29_g1[t]*A[t,14] +kᴬˢ_30_g1[t]*A[t,15]) -K_g[5,k]*λ_F[n,t] - Pˢᴳₘₐₓ[3]*μᵐᵃˣˢᴳ⁴_1[t]+ Pˢᴳₘᵢₙ[3]*μᵐⁱⁿˢᴳ⁴_1[t]+ Kˢᵗ[3]*(σˢᵗˢᴳ⁴_1[t]-σˢᵗˢᴳ⁴_1[t+1])+ Kˢʰ[3]*(σˢᵗˢᴳ⁴_1[t+1]-σˢᵗˢᴳ⁴_1[t])+ ψᵐᵃˣˢᴳ⁴_1[t] >=0)
...
@constraint(model, Oᵐ₁[1] -λᴱ[T] +μᵐᵃˣˢᴳ²_1[T] -μᵐⁱⁿˢᴳ²_1[T] +πʳᵘˢᴳ²_1[T] -πʳᵈˢᴳ²_1[T]>=0)                      # dual constraints for generation, when t==T,
...
@constraint(model, Oᵐ₁[3]*kᵐ_1[T] -λᴱ[T] +μᵐᵃˣˢᴳ⁴_1[T] -μᵐⁱⁿˢᴳ⁴_1[T] +πʳᵘˢᴳ⁴_1[T] -πʳᵈˢᴳ⁴_1[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1,
    ...
    @constraint(model, Oᵐ₁[3]*kᵐ_1[t] -λᴱ[t] +μᵐᵃˣˢᴳ⁴_1[t] -μᵐⁱⁿˢᴳ⁴_1[t] +πʳᵘˢᴳ⁴_1[t] -πʳᵘˢᴳ⁴_1[t+1] -πʳᵈˢᴳ⁴_1[t] +πʳᵈˢᴳ⁴_1[t+1]>=0)
...
#-------Define Objective Functions with McCormick envelopes
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g1[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Re_E_g1[t]>=M_λ*Pˢᴳ⁴_1[t]   +Pˢᴳₘₐₓ[3]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g1[t]<=λᴱ[t]*Pˢᴳₘₐₓ[3])
    @constraint(model, z_Re_E_g1[t]<=M_λ*Pˢᴳ⁴_1[t]   +Pˢᴳₘᵢₙ[3]*(λᴱ[t]-M_λ)  )
    ...
    @constraint(model, z_Bid_E_g1[t]>=Pˢᴳ⁴_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[3]-Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Bid_E_g1[t]>=kᵐᵐᵃˣ*Pˢᴳ⁴_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[3]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[3])
    @constraint(model, z_Bid_E_g1[t]<=kᵐᵐᵃˣ*Pˢᴳ⁴_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[3]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Bid_E_g1[t]<=Pˢᴳ⁴_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[3]-Pˢᴳₘₐₓ[3])
...
M_F_30=zeros(1,T)
for t in 1:T
    M_F_26[1,t]=maximum([kᴬˢᵐᵃˣ*A[t,13],kᴬˢᵐᵃˣ*A[t,28],A[t,1],A[t,4],A[t,7],A[t,16],A[t,19],A[t,22],A[t,7],A[t,10],A[t,25]])     
    M_F_29[1,t]=0
    M_F_30[1,t]=maximum([kᴬˢᵐᵃˣ*A[t,15],kᴬˢᵐᵃˣ*A[t,30],A[t,3],A[t,6],A[t,18],A[t,21],A[t,24],A[t,9],A[t,12],A[t,27]]) 
end
...
cost_nl_UL=sum(Oⁿˡ[3].*yˢᴳ⁴_1 ) + sum(Oⁿˡ[5].*yˢᴳ²⁷_2 )                 # no-load cost of strategic SGs
cost_gene_UL=sum(Oᵐ₁[3].*Pˢᴳ⁴_1) + sum(Oᵐ₂[5].*Pˢᴳ²⁷_2)                 # generation cost of strategic SGs 
...
revenue_SCL_UL=0*sum(z_Re_26_g1)+sum(z_Re_26_g2)+0*sum(z_Re_29_g1)+0*sum(z_Re_29_g2)+sum(z_Re_30_g1)+sum(z_Re_30_g2)    # revenue from commit online to offer AS
...
cost_gene_LL=sum(Oᵐ₁[3].* z_Bid_E_g1 )+ sum(Oᵐ₂[5].* z_Bid_E_g2 )+sum(Oᵐ₁[1].*Pˢᴳ²_1+Oᵐ₂[1].*Pˢᴳ²_2)+sum(Oᵐ₁[2].*Pˢᴳ³_1+Oᵐ₂[2].*Pˢᴳ³_2)+sum(Oᵐ₁[5].*Pˢᴳ²⁷_1+Oᵐ₂[3].*Pˢᴳ⁴_2)+sum(Oᵐ₁[4].*Pˢᴳ⁵_1+Oᵐ₂[4].*Pˢᴳ⁵_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,13].*z_Bid_26_g1 +A[:,14].*z_Bid_29_g1 +A[:,15].*z_Bid_30_g1 + A[:,28].*z_Bid_26_g2 +A[:,29].*z_Bid_29_g2 +A[:,30].*z_Bid_30_g2 )

cost_AS_non_stra=sum(A[:,1].*yˢᴳ²_1+A[:,2].*yˢᴳ²_1 +A[:,3].*yˢᴳ²_1 +A[:,4].*yˢᴳ²_2 +A[:,5].*yˢᴳ²_2 +A[:,6].*yˢᴳ²_2 +A[:,7].*yˢᴳ³_1 
+A[:,8].*yˢᴳ³_1 +A[:,9].*yˢᴳ³_1 +A[:,10].*yˢᴳ³_2 +A[:,11].*yˢᴳ³_2 +A[:,12].*yˢᴳ³_2 +A[:,25].*yˢᴳ²⁷_1 +A[:,26].*yˢᴳ²⁷_1 +A[:,27].*yˢᴳ²⁷_1 
...
cost_nl_G2_1=sum(Oⁿˡ[1].*yˢᴳ²_1)   
cost_gene_G2_1=sum(Oᵐ₁[1].*Pˢᴳ²_1)
revenue_energy_G2_1=sum(λᴱ.*Pˢᴳ²_1)
revenue_SCL_G2_1=sum( (0*λ_F[1,:]+0*λ_F[2,:]+λ_F[3,:]).*yˢᴳ²_1)
...
cost_nl_G2_2=sum(Oⁿˡ[1].*yˢᴳ²_2)
cost_gene_G2_2=sum(Oᵐ₂[1].*Pˢᴳ²_2)
revenue_energy_G2_2=sum(λᴱ.*Pˢᴳ²_2)
revenue_SCL_G2_2=sum( (0*λ_F[1,:]+0*λ_F[2,:]+λ_F[3,:]).*yˢᴳ²_2)
...
costs_G27_2=cost_nl_G27_2+cost_gene_G27_2+cost_onoff_G27_2
profits_G27_2=revenue_energy_G27_2+revenue_SCL_G27_2-costs_G27_2
revenue_SCL_G27_2+revenue_SCL_G27_1
matwrite("SCL_prices_bus_distant_26.mat", Dict("SCL_prices_bus_distant_26" => λ_F[1,:]))
matwrite("SCL_prices_bus_distant_29.mat", Dict("SCL_prices_bus_distant_29" => λ_F[2,:]))
matwrite("SCL_prices_bus_distant_30.mat", Dict("SCL_prices_bus_distant_30" => λ_F[3,:]))