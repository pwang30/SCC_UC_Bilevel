...
kᵐᵐᵃˣ= 2                                                            # Bidding variable_energy upper bound
...
@variable(model, kᵐ_3[1:T])     
@variable(model, kᴬˢ_26_g1[1:T]) 
@variable(model, kᴬˢ_26_g2[1:T]) 
@variable(model, kᴬˢ_26_g3[1:T])
@variable(model, kᴬˢ_29_g1[1:T])
@variable(model, kᴬˢ_29_g2[1:T])
@variable(model, kᴬˢ_29_g3[1:T])
@variable(model, kᴬˢ_30_g1[1:T])
@variable(model, kᴬˢ_30_g2[1:T])
@variable(model, kᴬˢ_30_g3[1:T])

@variable(model, Pˢᴳ²_1[1:T])        # generation of SGs , buses:2,3,4,5,27,30.  Include strategic non-strategic players
...
@constraint(model, kᵐ_3.>=1)            
@constraint(model, kᵐ_3.<=kᵐᵐᵃˣ)
...
@constraint(model, kᴬˢ_26_g3.>=1)            
@constraint(model, kᴬˢ_26_g3.<=kᴬˢᵐᵃˣ)
...
@constraint(model, kᴬˢ_29_g3.>=1)            
@constraint(model, kᴬˢ_29_g3.<=kᴬˢᵐᵃˣ)
...
@constraint(model, kᴬˢ_30_g3.>=1)            
@constraint(model, kᴬˢ_30_g3.<=kᴬˢᵐᵃˣ)
...
@constraint(model, Oⁿˡ[1] +sum( A[T,4] +A[T,5] +A[T,6]) -K_g[2,k]*λ_F[n,T] -Pˢᴳₘₐₓ[1]*μᵐᵃˣˢᴳ²_2[T] +Pˢᴳₘᵢₙ[1]*μᵐⁱⁿˢᴳ²_2[T] +Kˢᵗ[1]*σˢᵗˢᴳ²_2[T] -Kˢʰ[1]*σˢʰˢᴳ²_2[T]+ ψᵐᵃˣˢᴳ²_2[T] >=0)
...
@constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g2[T]*A[T,25] +kᴬˢ_29_g2[T]*A[T,26] +kᴬˢ_30_g2[T]*A[T,27]) -K_g[9,k]*λ_F[n,T] -Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_1[T] +Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_1[T] +Kˢᵗ[5]*σˢᵗˢᴳ²⁷_1[T] -Kˢʰ[5]*σˢʰˢᴳ²⁷_1[T]+ ψᵐᵃˣˢᴳ²⁷_1[T] >=0)
@constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g3[T]*A[T,28] +kᴬˢ_29_g3[T]*A[T,29] +kᴬˢ_30_g3[T]*A[T,30]) -K_g[10,k]*λ_F[n,T] -Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_2[T] +Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_2[T] +Kˢᵗ[5]*σˢᵗˢᴳ²⁷_2[T] -Kˢʰ[5]*σˢʰˢᴳ²⁷_2[T]+ ψᵐᵃˣˢᴳ²⁷_2[T] >=0)
...
for t in 1:T-1                                                                                                                                                       # dual constraints for UC, when t<=T-1
    ...
    @constraint(model, Oⁿˡ[1] +sum( A[t,4] +A[t,5] +A[t,6]) -K_g[2,k]*λ_F[n,t] - Pˢᴳₘₐₓ[1]*μᵐᵃˣˢᴳ²_2[t]+ Pˢᴳₘᵢₙ[1]*μᵐⁱⁿˢᴳ²_2[t]+ Kˢᵗ[1]*(σˢᵗˢᴳ²_2[t]-σˢᵗˢᴳ²_2[t+1])+ Kˢʰ[1]*(σˢᵗˢᴳ²_2[t+1]-σˢᵗˢᴳ²_2[t])+ ψᵐᵃˣˢᴳ²_2[t] >=0)   
    ...
    @constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g2[t]*A[t,25] +kᴬˢ_29_g2[t]*A[t,26] +kᴬˢ_30_g2[t]*A[t,27]) -K_g[9,k]*λ_F[n,t] - Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_1[t]+ Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_1[t]+ Kˢᵗ[5]*(σˢᵗˢᴳ²⁷_1[t]-σˢᵗˢᴳ²⁷_1[t+1])+ Kˢʰ[5]*(σˢᵗˢᴳ²⁷_1[t+1]-σˢᵗˢᴳ²⁷_1[t])+ ψᵐᵃˣˢᴳ²⁷_1[t] >=0)
    @constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g3[t]*A[t,28] +kᴬˢ_29_g3[t]*A[t,29] +kᴬˢ_30_g3[t]*A[t,30]) -K_g[10,k]*λ_F[n,t] - Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_2[t]+ Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_2[t]+ Kˢᵗ[5]*(σˢᵗˢᴳ²⁷_2[t]-σˢᵗˢᴳ²⁷_2[t+1])+ Kˢʰ[5]*(σˢᵗˢᴳ²⁷_2[t+1]-σˢᵗˢᴳ²⁷_2[t])+ ψᵐᵃˣˢᴳ²⁷_2[t] >=0)
...
@constraint(model, Oᵐ₁[5]*kᵐ_2[T] -λᴱ[T] +μᵐᵃˣˢᴳ²⁷_1[T] -μᵐⁱⁿˢᴳ²⁷_1[T] +πʳᵘˢᴳ²⁷_1[T] -πʳᵈˢᴳ²⁷_1[T]>=0)
@constraint(model, Oᵐ₂[5]*kᵐ_3[T] -λᴱ[T] +μᵐᵃˣˢᴳ²⁷_2[T] -μᵐⁱⁿˢᴳ²⁷_2[T] +πʳᵘˢᴳ²⁷_2[T] -πʳᵈˢᴳ²⁷_2[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1, assume SGs in bus 2 are strategic
    ...
    @constraint(model, Oᵐ₁[5]*kᵐ_2[t] -λᴱ[t] +μᵐᵃˣˢᴳ²⁷_1[t] -μᵐⁱⁿˢᴳ²⁷_1[t] +πʳᵘˢᴳ²⁷_1[t] -πʳᵘˢᴳ²⁷_1[t+1] -πʳᵈˢᴳ²⁷_1[t] +πʳᵈˢᴳ²⁷_1[t+1]>=0)
    @constraint(model, Oᵐ₂[5]*kᵐ_3[t] -λᴱ[t] +μᵐᵃˣˢᴳ²⁷_2[t] -μᵐⁱⁿˢᴳ²⁷_2[t] +πʳᵘˢᴳ²⁷_2[t] -πʳᵘˢᴳ²⁷_2[t+1] -πʳᵈˢᴳ²⁷_2[t] +πʳᵈˢᴳ²⁷_2[t+1]>=0)
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g2[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Re_E_g2[t]>=M_λ*Pˢᴳ²⁷_1[t]   +Pˢᴳₘₐₓ[5]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g2[t]<=λᴱ[t]*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Re_E_g2[t]<=M_λ*Pˢᴳ²⁷_1[t]   +Pˢᴳₘᵢₙ[5]*(λᴱ[t]-M_λ)  )

    @constraint(model, z_Re_E_g3[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Re_E_g3[t]>=M_λ*Pˢᴳ²⁷_2[t]   +Pˢᴳₘₐₓ[5]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g3[t]<=λᴱ[t]*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Re_E_g3[t]<=M_λ*Pˢᴳ²⁷_2[t]   +Pˢᴳₘᵢₙ[5]*(λᴱ[t]-M_λ)  )
    ...
    @constraint(model, z_Bid_E_g2[t]>=Pˢᴳ²⁷_1[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[5]-Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g2[t]>=kᵐᵐᵃˣ*Pˢᴳ²⁷_1[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[5]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Bid_E_g2[t]<=kᵐᵐᵃˣ*Pˢᴳ²⁷_1[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[5]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g2[t]<=Pˢᴳ²⁷_1[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[5]-Pˢᴳₘₐₓ[5])

    @constraint(model, z_Bid_E_g3[t]>=Pˢᴳ²⁷_2[t]+kᵐ_3[t]*Pˢᴳₘᵢₙ[5]-Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g3[t]>=kᵐᵐᵃˣ*Pˢᴳ²⁷_2[t]+kᵐ_3[t]*Pˢᴳₘₐₓ[5]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Bid_E_g3[t]<=kᵐᵐᵃˣ*Pˢᴳ²⁷_2[t]+kᵐ_3[t]*Pˢᴳₘᵢₙ[5]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g3[t]<=Pˢᴳ²⁷_2[t]+kᵐ_3[t]*Pˢᴳₘₐₓ[5]-Pˢᴳₘₐₓ[5])
...
M_F_30=zeros(1,T)
for t in 1:T
    M_F_26[1,t]=maximum([kᴬˢᵐᵃˣ*A[t,1],kᴬˢᵐᵃˣ*A[t,25],kᴬˢᵐᵃˣ*A[t,28],A[t,7],A[t,10],A[t,13],A[t,16],A[t,19],A[t,22],A[t,4],A[t,31],A[t,34]])     
    M_F_29[1,t]=0
    M_F_30[1,t]=maximum([kᴬˢᵐᵃˣ*A[t,3],kᴬˢᵐᵃˣ*A[t,27],kᴬˢᵐᵃˣ*A[t,30],A[t,9],A[t,12],A[t,15],A[t,18],A[t,21],A[t,24],A[t,6],A[t,33],A[t,36]]) 
end


@variable(model, z_Re_26_g1[1:T]>=0)    # equal to λ_F*y_g, SG 1， bus 26
@variable(model, z_Re_26_g2[1:T]>=0)    # equal to λ_F*y_g, SG 2， bus 26
@variable(model, z_Re_26_g3[1:T]>=0)    # equal to λ_F*y_g, SG 3， bus 26
@variable(model, z_Re_29_g1[1:T]>=0)    # equal to λ_F*y_g, SG 1， bus 29
@variable(model, z_Re_29_g2[1:T]>=0)    # equal to λ_F*y_g, SG 2， bus 29
@variable(model, z_Re_29_g3[1:T]>=0)    # equal to λ_F*y_g, SG 3， bus 29
@variable(model, z_Re_30_g1[1:T]>=0)    # equal to λ_F*y_g, SG 1， bus 30
@variable(model, z_Re_30_g2[1:T]>=0)    # equal to λ_F*y_g, SG 2， bus 30
@variable(model, z_Re_30_g3[1:T]>=0)    # equal to λ_F*y_g, SG 3， bus 30
for t in 1:T
    @constraint(model, z_Re_26_g1[t]<=M_F_26[1,t]*yˢᴳ²_1[t])
    @constraint(model, z_Re_26_g2[t]<=M_F_26[1,t]*yˢᴳ²⁷_1[t])
    @constraint(model, z_Re_26_g3[t]<=M_F_26[1,t]*yˢᴳ²⁷_2[t])

    @constraint(model, λ_F[1,t]-M_F_26[1,t]*(1-yˢᴳ²_1[t])<=z_Re_26_g1[t])
    @constraint(model, λ_F[1,t]-M_F_26[1,t]*(1-yˢᴳ²⁷_1[t])<=z_Re_26_g2[t])
    @constraint(model, λ_F[1,t]-M_F_26[1,t]*(1-yˢᴳ²⁷_2[t])<=z_Re_26_g3[t])

    @constraint(model, z_Re_26_g1[t]<=λ_F[1,t])
    @constraint(model, z_Re_26_g2[t]<=λ_F[1,t])
    @constraint(model, z_Re_26_g3[t]<=λ_F[1,t])
end

for t in 1:T
    @constraint(model, z_Re_29_g1[t]<=M_F_29[1,t]*yˢᴳ²_1[t])
    @constraint(model, z_Re_29_g2[t]<=M_F_29[1,t]*yˢᴳ²⁷_1[t])
    @constraint(model, z_Re_29_g3[t]<=M_F_29[1,t]*yˢᴳ²⁷_2[t])

    @constraint(model, λ_F[2,t]-M_F_29[1,t]*(1-yˢᴳ²_1[t])<=z_Re_29_g1[t])
    @constraint(model, λ_F[2,t]-M_F_29[1,t]*(1-yˢᴳ²⁷_1[t])<=z_Re_29_g2[t])
    @constraint(model, λ_F[2,t]-M_F_29[1,t]*(1-yˢᴳ²⁷_2[t])<=z_Re_29_g3[t])

    @constraint(model, z_Re_29_g1[t]<=λ_F[2,t])
    @constraint(model, z_Re_29_g2[t]<=λ_F[2,t])
    @constraint(model, z_Re_29_g3[t]<=λ_F[2,t])
end

for t in 1:T
    @constraint(model, z_Re_30_g1[t]<=M_F_30[1,t]*yˢᴳ²_1[t])
    @constraint(model, z_Re_30_g2[t]<=M_F_30[1,t]*yˢᴳ²⁷_1[t])
    @constraint(model, z_Re_30_g3[t]<=M_F_30[1,t]*yˢᴳ²⁷_2[t])

    @constraint(model, λ_F[3,t]-M_F_30[1,t]*(1-yˢᴳ²_1[t])<=z_Re_30_g1[t])
    @constraint(model, λ_F[3,t]-M_F_30[1,t]*(1-yˢᴳ²⁷_1[t])<=z_Re_30_g2[t])
    @constraint(model, λ_F[3,t]-M_F_30[1,t]*(1-yˢᴳ²⁷_2[t])<=z_Re_30_g3[t])

    @constraint(model, z_Re_30_g1[t]<=λ_F[3,t])
    @constraint(model, z_Re_30_g2[t]<=λ_F[3,t])
    @constraint(model, z_Re_30_g3[t]<=λ_F[3,t])
end

@variable(model, z_Bid_26_g1[1:T])    # equal to k_F*y_g, SG 1， bus 26
@variable(model, z_Bid_26_g2[1:T])    # equal to k_F*y_g, SG 2， bus 26
@variable(model, z_Bid_26_g3[1:T])    # equal to k_F*y_g, SG 3， bus 26
@variable(model, z_Bid_29_g1[1:T])    # equal to k_F*y_g, SG 1， bus 29
@variable(model, z_Bid_29_g2[1:T])    # equal to k_F*y_g, SG 2， bus 29
@variable(model, z_Bid_29_g3[1:T])    # equal to k_F*y_g, SG 3， bus 29
@variable(model, z_Bid_30_g1[1:T])    # equal to k_F*y_g, SG 1， bus 30
@variable(model, z_Bid_30_g2[1:T])    # equal to k_F*y_g, SG 2， bus 30
@variable(model, z_Bid_30_g3[1:T])    # equal to k_F*y_g, SG 3， bus 30

for t in 1:T
    @constraint(model, z_Bid_26_g1[t]<=kᴬˢᵐᵃˣ*yˢᴳ²_1[t])
    @constraint(model, z_Bid_26_g2[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_26_g3[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_26_g1[t]<=yˢᴳ²_1[t]+kᴬˢ_26_g1[t]-1)
    @constraint(model, z_Bid_26_g2[t]<=yˢᴳ²⁷_1[t]+kᴬˢ_26_g2[t]-1)
    @constraint(model, z_Bid_26_g3[t]<=yˢᴳ²⁷_2[t]+kᴬˢ_26_g3[t]-1)

    @constraint(model, z_Bid_26_g1[t]>=yˢᴳ²_1[t])
    @constraint(model, z_Bid_26_g2[t]>=yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_26_g3[t]>=yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_26_g1[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²_1[t]-1)+kᴬˢ_26_g1[t])
    @constraint(model, z_Bid_26_g2[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_1[t]-1)+kᴬˢ_26_g2[t]) 
    @constraint(model, z_Bid_26_g3[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_2[t]-1)+kᴬˢ_26_g3[t])  
end

for t in 1:T
    @constraint(model, z_Bid_29_g1[t]<=kᴬˢᵐᵃˣ*yˢᴳ²_1[t])
    @constraint(model, z_Bid_29_g2[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_29_g3[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_29_g1[t]<=yˢᴳ²_1[t]+kᴬˢ_29_g1[t]-1)
    @constraint(model, z_Bid_29_g2[t]<=yˢᴳ²⁷_1[t]+kᴬˢ_29_g2[t]-1)
    @constraint(model, z_Bid_29_g3[t]<=yˢᴳ²⁷_2[t]+kᴬˢ_29_g3[t]-1)

    @constraint(model, z_Bid_29_g1[t]>=yˢᴳ²_1[t])
    @constraint(model, z_Bid_29_g2[t]>=yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_29_g3[t]>=yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_29_g1[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²_1[t]-1)+kᴬˢ_29_g1[t])
    @constraint(model, z_Bid_29_g2[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_1[t]-1)+kᴬˢ_29_g2[t])   
    @constraint(model, z_Bid_29_g3[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_2[t]-1)+kᴬˢ_29_g3[t])
end

for t in 1:T
    @constraint(model, z_Bid_30_g1[t]<=kᴬˢᵐᵃˣ*yˢᴳ²_1[t])
    @constraint(model, z_Bid_30_g2[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_30_g3[t]<=kᴬˢᵐᵃˣ*yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_30_g1[t]<=yˢᴳ²_1[t]+kᴬˢ_30_g1[t]-1)
    @constraint(model, z_Bid_30_g2[t]<=yˢᴳ²⁷_1[t]+kᴬˢ_30_g2[t]-1)
    @constraint(model, z_Bid_30_g3[t]<=yˢᴳ²⁷_2[t]+kᴬˢ_30_g3[t]-1)

    @constraint(model, z_Bid_30_g1[t]>=yˢᴳ²_1[t])
    @constraint(model, z_Bid_30_g2[t]>=yˢᴳ²⁷_1[t])
    @constraint(model, z_Bid_30_g3[t]>=yˢᴳ²⁷_2[t])

    @constraint(model, z_Bid_30_g1[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²_1[t]-1)+kᴬˢ_30_g1[t])
    @constraint(model, z_Bid_30_g2[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_1[t]-1)+kᴬˢ_30_g2[t])   
    @constraint(model, z_Bid_30_g3[t]>=kᴬˢᵐᵃˣ*(yˢᴳ²⁷_2[t]-1)+kᴬˢ_30_g3[t])
end



#-------Define Objective Functions 
cost_nl_UL=sum(Oⁿˡ[1].*yˢᴳ²_1 ) + sum(Oⁿˡ[5].*yˢᴳ²⁷_1 ) + sum(Oⁿˡ[5].*yˢᴳ²⁷_2 )                 # no-load cost of strategic SGs
cost_gene_UL=sum(Oᵐ₁[1].*Pˢᴳ²_1) + sum(Oᵐ₁[5].*Pˢᴳ²⁷_1) + sum(Oᵐ₂[5].*Pˢᴳ²⁷_2)                  # generation cost of strategic SGs 
cost_onoff_UL=sum(Cᵁ²_1)+sum(Cᴰ²_1) +sum(Cᵁ²⁷_1)+sum(Cᴰ²⁷_1) +sum(Cᵁ²⁷_2)+sum(Cᴰ²⁷_2)              # on/off cost of strategic SGs
revenue_energy_UL=sum( z_Re_E_g1 )+sum( z_Re_E_g2 )+sum( z_Re_E_g3 )                     # revenue from market clearing
revenue_SCL_UL=0*sum(z_Re_26_g1) +sum(z_Re_26_g2) +sum(z_Re_26_g3) +sum(z_Re_30_g1) +sum(z_Re_30_g2) +sum(z_Re_30_g3)  # revenue from commit online to offer AS
...
cost_gene_LL=sum(Oᵐ₁[1].* z_Bid_E_g1 )+ sum(Oᵐ₁[5].* z_Bid_E_g2 )+ sum(Oᵐ₂[5].* z_Bid_E_g3 )   +sum(Oᵐ₂[1]*Pˢᴳ²_2)+ sum(Oᵐ₁[2].*Pˢᴳ³_1+Oᵐ₂[2].*Pˢᴳ³_2)+sum(Oᵐ₁[3].*Pˢᴳ⁴_1+Oᵐ₂[3].*Pˢᴳ⁴_2)+sum(Oᵐ₁[4].*Pˢᴳ⁵_1+Oᵐ₂[4].*Pˢᴳ⁵_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,1].*z_Bid_26_g1 +A[:,2].*z_Bid_29_g1 +A[:,3].*z_Bid_30_g1 + A[:,25].*z_Bid_26_g2 +A[:,26].*z_Bid_29_g2 +A[:,27].*z_Bid_30_g2 +A[:,28].*z_Bid_26_g3 +A[:,29].*z_Bid_29_g3 +A[:,30].*z_Bid_30_g3 )
...
+A[:,22].*yˢᴳ⁵_2 +A[:,23].*yˢᴳ⁵_2 +A[:,24].*yˢᴳ⁵_2 +A[:,4].*yˢᴳ²_2 +A[:,5].*yˢᴳ²_2 +A[:,6].*yˢᴳ²_2 +A[:,31].*yˢᴳ³⁰_1 +A[:,32].*yˢᴳ³⁰_1 +A[:,33].*yˢᴳ³⁰_1 +A[:,34].*yˢᴳ³⁰_2 +A[:,35].*yˢᴳ³⁰_2 +A[:,36].*yˢᴳ³⁰_2)
...
matwrite("SCL_prices_21_271_272_26.mat", Dict("SCL_prices_21_271_272_26" => λ_F[1,:]))
matwrite("SCL_prices_21_271_272_30.mat", Dict("SCL_prices_21_271_272_30" => λ_F[3,:]))
