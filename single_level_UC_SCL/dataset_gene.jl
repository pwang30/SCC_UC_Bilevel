...
I_sc_all=zeros(Ω,numnodes)            # SCC at fault bus F=4
...
for j in 1:numnodes
    for k in 1:Ω
        ...
        I_sc_all[k,j] = (Z[j,2]*Iₛ₉[1]*status_SGs[1]+ Z[j,3]*Iₛ₉[2]*status_SGs[2]+ Z[j,4]*Iₛ₉[3]*status_SGs[3]+
