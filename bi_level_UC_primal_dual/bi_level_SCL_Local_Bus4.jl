...
@constraint(model, Oⁿˡ[3] +sum( kᴬˢ_26_g2[T]*A[T,16] +kᴬˢ_29_g2[T]*A[T,17] +kᴬˢ_30_g2[T]*A[T,18]) -K_g[6,k]*λ_F[n,T] -Pˢᴳₘₐₓ[3]*μᵐᵃˣˢᴳ⁴_2[T] +Pˢᴳₘᵢₙ[3]*μᵐⁱⁿˢᴳ⁴_2[T] +Kˢᵗ[3]*σˢᵗˢᴳ⁴_2[T] -Kˢʰ[3]*σˢʰˢᴳ⁴_2[T]+ ψᵐᵃˣˢᴳ⁴_2[T] >=0)
...
for t in 1:T-1                                                                                                                                                       # dual constraints for UC, when t<=T-1
    ...
    @constraint(model, Oⁿˡ[3] +sum( kᴬˢ_26_g2[t]*A[t,16] +kᴬˢ_29_g2[t]*A[t,17] +kᴬˢ_30_g2[t]*A[t,18]) -K_g[6,k]*λ_F[n,t] - Pˢᴳₘₐₓ[3]*μᵐᵃˣˢᴳ⁴_2[t]+ Pˢᴳₘᵢₙ[3]*μᵐⁱⁿˢᴳ⁴_2[t]+ Kˢᵗ[3]*(σˢᵗˢᴳ⁴_2[t]-σˢᵗˢᴳ⁴_2[t+1])+ Kˢʰ[3]*(σˢᵗˢᴳ⁴_2[t+1]-σˢᵗˢᴳ⁴_2[t])+ ψᵐᵃˣˢᴳ⁴_2[t] >=0)
...
@constraint(model, Oᵐ₂[3]*kᵐ_2[T] -λᴱ[T] +μᵐᵃˣˢᴳ⁴_2[T] -μᵐⁱⁿˢᴳ⁴_2[T] +πʳᵘˢᴳ⁴_2[T] -πʳᵈˢᴳ⁴_2[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1, assume SGs in bus 2 are strategic
    ...
    @constraint(model, Oᵐ₂[3]*kᵐ_2[t] -λᴱ[t] +μᵐᵃˣˢᴳ⁴_2[t] -μᵐⁱⁿˢᴳ⁴_2[t] +πʳᵘˢᴳ⁴_2[t] -πʳᵘˢᴳ⁴_2[t+1] -πʳᵈˢᴳ⁴_2[t] +πʳᵈˢᴳ⁴_2[t+1]>=0)
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g2[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Re_E_g2[t]>=M_λ*Pˢᴳ⁴_2[t]   +Pˢᴳₘₐₓ[3]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g2[t]<=λᴱ[t]*Pˢᴳₘₐₓ[3])
    @constraint(model, z_Re_E_g2[t]<=M_λ*Pˢᴳ⁴_2[t]   +Pˢᴳₘᵢₙ[3]*(λᴱ[t]-M_λ)  )
    ...
    @constraint(model, z_Bid_E_g2[t]>=Pˢᴳ⁴_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[3]-Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Bid_E_g2[t]>=kᵐᵐᵃˣ*Pˢᴳ⁴_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[3]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[3])
    @constraint(model, z_Bid_E_g2[t]<=kᵐᵐᵃˣ*Pˢᴳ⁴_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[3]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[3])
    @constraint(model, z_Bid_E_g2[t]<=Pˢᴳ⁴_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[3]-Pˢᴳₘₐₓ[3])
...
cost_nl_UL=sum(Oⁿˡ[3].*yˢᴳ⁴_1 ) + sum(Oⁿˡ[3].*yˢᴳ⁴_2 )                  # no-load cost of strategic SGs
...
cost_gene_LL=sum(Oᵐ₁[3].* z_Bid_E_g1 )+ sum(Oᵐ₂[3].* z_Bid_E_g2 )+sum(Oᵐ₁[1].*Pˢᴳ²_1+Oᵐ₂[1].*Pˢᴳ²_2)+sum(Oᵐ₁[2].*Pˢᴳ³_1+Oᵐ₂[2].*Pˢᴳ³_2)+sum(Oᵐ₁[4].*Pˢᴳ⁵_1+Oᵐ₂[4].*Pˢᴳ⁵_2)+sum(Oᵐ₁[5].*Pˢᴳ²⁷_1+Oᵐ₂[5].*Pˢᴳ²⁷_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,13].*z_Bid_26_g1 +A[:,14].*z_Bid_29_g1 +A[:,15].*z_Bid_30_g1 + A[:,16].*z_Bid_26_g2 +A[:,17].*z_Bid_29_g2 +A[:,18].*z_Bid_30_g2 )

cost_AS_non_stra=sum(A[:,1].*yˢᴳ²_1+A[:,2].*yˢᴳ²_1 +A[:,3].*yˢᴳ²_1 +A[:,4].*yˢᴳ²_2 +A[:,5].*yˢᴳ²_2 +A[:,6].*yˢᴳ²_2 +A[:,7].*yˢᴳ³_1 
+A[:,8].*yˢᴳ³_1 +A[:,9].*yˢᴳ³_1 +A[:,10].*yˢᴳ³_2 +A[:,11].*yˢᴳ³_2 +A[:,12].*yˢᴳ³_2 +A[:,19].*yˢᴳ⁵_1 +A[:,20].*yˢᴳ⁵_1 +A[:,21].*yˢᴳ⁵_1 
...
matwrite("k_bus_4.mat", Dict("k_bus_4" => kᵐ))

matwrite("energy_prices_bus_4.mat", Dict("energy_prices_bus_4" => λᴱ))

matwrite("SCL_prices_bus_4_26.mat", Dict("SCL_prices_bus_4_26" => λ_F[1,:]))
matwrite("SCL_prices_bus_4_29.mat", Dict("SCL_prices_bus_4_29" => λ_F[2,:]))
matwrite("SCL_prices_bus_4_30.mat", Dict("SCL_prices_bus_4_30" => λ_F[3,:]))

matwrite("I_bus_4_26.mat", Dict("I_bus_4_26" => I_₂₆))
matwrite("I_bus_4_29.mat", Dict("I_bus_4_29" => I_₂₉))
matwrite("I_bus_4_30.mat", Dict("I_bus_4_30" => I_₃₀))

matwrite("reveunes_UL_bus_4.mat", Dict("reveunes_UL_bus_4" => reveunes_UL))
matwrite("costs_UL_bus_4.mat", Dict("costs_UL_bus_4" => costs_UL))
matwrite("profits_UL_bus_4.mat", Dict("profits_UL_bus_4" => obj_UL))

matwrite("profits_bus_4_G3_1.mat", Dict("profits_bus_4_G3_1" => profits_G3_1))
matwrite("profits_bus_4_G3_2.mat", Dict("profits_bus_4_G3_2" => profits_G3_2))
matwrite("profits_bus_4_G2_1.mat", Dict("profits_bus_4_G2_1" => profits_G2_1))
matwrite("profits_bus_4_G2_2.mat", Dict("profits_bus_4_G2_2" => profits_G2_2))
matwrite("profits_bus_4_G5_1.mat", Dict("profits_bus_4_G5_1" => profits_G5_1))
matwrite("profits_bus_4_G5_2.mat", Dict("profits_bus_4_G5_2" => profits_G5_2))
matwrite("profits_bus_4_G27_1.mat", Dict("profits_bus_4_G27_1" => profits_G27_1))
matwrite("profits_bus_4_G27_2.mat", Dict("profits_bus_4_G27_2" => profits_G27_2))
matwrite("profits_bus_4_G30_1.mat", Dict("profits_bus_4_G30_1" => profits_G30_1))
matwrite("profits_bus_4_G30_2.mat", Dict("profits_bus_4_G30_2" => profits_G30_2))
...
matwrite("SCL_offer_price.mat", Dict("SCL_offer_price" => A))
