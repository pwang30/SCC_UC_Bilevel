...
@constraint(model, Oⁿˡ[4] +sum( kᴬˢ_26_g1[T]*A[T,19] +kᴬˢ_29_g1[T]*A[T,20] +kᴬˢ_30_g1[T]*A[T,21]) -K_g[7,k]*λ_F[n,T] -Pˢᴳₘₐₓ[4]*μᵐᵃˣˢᴳ⁵_1[T] +Pˢᴳₘᵢₙ[4]*μᵐⁱⁿˢᴳ⁵_1[T] +Kˢᵗ[4]*σˢᵗˢᴳ⁵_1[T] -Kˢʰ[4]*σˢʰˢᴳ⁵_1[T]+ ψᵐᵃˣˢᴳ⁵_1[T] >=0)
@constraint(model, Oⁿˡ[4] +sum( kᴬˢ_26_g2[T]*A[T,22] +kᴬˢ_29_g2[T]*A[T,23] +kᴬˢ_30_g2[T]*A[T,24]) -K_g[8,k]*λ_F[n,T] -Pˢᴳₘₐₓ[4]*μᵐᵃˣˢᴳ⁵_2[T] +Pˢᴳₘᵢₙ[4]*μᵐⁱⁿˢᴳ⁵_2[T] +Kˢᵗ[4]*σˢᵗˢᴳ⁵_2[T] -Kˢʰ[4]*σˢʰˢᴳ⁵_2[T]+ ψᵐᵃˣˢᴳ⁵_2[T] >=0)
...
for t in 1:T-1                                                                                                                                                       # dual constraints for UC, when t<=T-1
    ...
    @constraint(model, Oⁿˡ[4] +sum( kᴬˢ_26_g1[t]*A[t,19] +kᴬˢ_29_g1[t]*A[t,20] +kᴬˢ_30_g1[t]*A[t,21]) -K_g[7,k]*λ_F[n,t] - Pˢᴳₘₐₓ[4]*μᵐᵃˣˢᴳ⁵_1[t]+ Pˢᴳₘᵢₙ[4]*μᵐⁱⁿˢᴳ⁵_1[t]+ Kˢᵗ[4]*(σˢᵗˢᴳ⁵_1[t]-σˢᵗˢᴳ⁵_1[t+1])+ Kˢʰ[4]*(σˢᵗˢᴳ⁵_1[t+1]-σˢᵗˢᴳ⁵_1[t])+ ψᵐᵃˣˢᴳ⁵_1[t] >=0)
    @constraint(model, Oⁿˡ[4] +sum( kᴬˢ_26_g2[t]*A[t,22] +kᴬˢ_29_g2[t]*A[t,23] +kᴬˢ_30_g2[t]*A[t,24]) -K_g[8,k]*λ_F[n,t] - Pˢᴳₘₐₓ[4]*μᵐᵃˣˢᴳ⁵_2[t]+ Pˢᴳₘᵢₙ[4]*μᵐⁱⁿˢᴳ⁵_2[t]+ Kˢᵗ[4]*(σˢᵗˢᴳ⁵_2[t]-σˢᵗˢᴳ⁵_2[t+1])+ Kˢʰ[4]*(σˢᵗˢᴳ⁵_2[t+1]-σˢᵗˢᴳ⁵_2[t])+ ψᵐᵃˣˢᴳ⁵_2[t] >=0)
...
@constraint(model, Oᵐ₁[4]*kᵐ_1[T] -λᴱ[T] +μᵐᵃˣˢᴳ⁵_1[T] -μᵐⁱⁿˢᴳ⁵_1[T] +πʳᵘˢᴳ⁵_1[T] -πʳᵈˢᴳ⁵_1[T]>=0)
@constraint(model, Oᵐ₂[4]*kᵐ_2[T] -λᴱ[T] +μᵐᵃˣˢᴳ⁵_2[T] -μᵐⁱⁿˢᴳ⁵_2[T] +πʳᵘˢᴳ⁵_2[T] -πʳᵈˢᴳ⁵_2[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1, assume SGs in bus 2 are strategic
    ...
    @constraint(model, Oᵐ₁[4]*kᵐ_1[t] -λᴱ[t] +μᵐᵃˣˢᴳ⁵_1[t] -μᵐⁱⁿˢᴳ⁵_1[t] +πʳᵘˢᴳ⁵_1[t] -πʳᵘˢᴳ⁵_1[t+1] -πʳᵈˢᴳ⁵_1[t] +πʳᵈˢᴳ⁵_1[t+1]>=0)
    @constraint(model, Oᵐ₂[4]*kᵐ_2[t] -λᴱ[t] +μᵐᵃˣˢᴳ⁵_2[t] -μᵐⁱⁿˢᴳ⁵_2[t] +πʳᵘˢᴳ⁵_2[t] -πʳᵘˢᴳ⁵_2[t+1] -πʳᵈˢᴳ⁵_2[t] +πʳᵈˢᴳ⁵_2[t+1]>=0)
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g1[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Re_E_g1[t]>=M_λ*Pˢᴳ⁵_1[t]   +Pˢᴳₘₐₓ[4]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g1[t]<=λᴱ[t]*Pˢᴳₘₐₓ[4])
    @constraint(model, z_Re_E_g1[t]<=M_λ*Pˢᴳ⁵_1[t]   +Pˢᴳₘᵢₙ[4]*(λᴱ[t]-M_λ)  )
    
    @constraint(model, z_Re_E_g2[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Re_E_g2[t]>=M_λ*Pˢᴳ⁵_2[t]   +Pˢᴳₘₐₓ[4]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g2[t]<=λᴱ[t]*Pˢᴳₘₐₓ[4])
    @constraint(model, z_Re_E_g2[t]<=M_λ*Pˢᴳ⁵_2[t]   +Pˢᴳₘᵢₙ[4]*(λᴱ[t]-M_λ)  )

    @constraint(model, z_Bid_E_g1[t]>=Pˢᴳ⁵_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[4]-Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Bid_E_g1[t]>=kᵐᵐᵃˣ*Pˢᴳ⁵_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[4]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[4])
    @constraint(model, z_Bid_E_g1[t]<=kᵐᵐᵃˣ*Pˢᴳ⁵_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[4]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Bid_E_g1[t]<=Pˢᴳ⁵_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[4]-Pˢᴳₘₐₓ[4])

    @constraint(model, z_Bid_E_g2[t]>=Pˢᴳ⁵_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[4]-Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Bid_E_g2[t]>=kᵐᵐᵃˣ*Pˢᴳ⁵_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[4]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[4])
    @constraint(model, z_Bid_E_g2[t]<=kᵐᵐᵃˣ*Pˢᴳ⁵_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[4]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[4])
    @constraint(model, z_Bid_E_g2[t]<=Pˢᴳ⁵_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[4]-Pˢᴳₘₐₓ[4])
...
cost_nl_UL=sum(Oⁿˡ[4].*yˢᴳ⁵_1 ) + sum(Oⁿˡ[4].*yˢᴳ⁵_2 )                  # no-load cost of strategic SGs
cost_gene_UL=sum(Oᵐ₁[4].*Pˢᴳ⁵_1) + sum(Oᵐ₂[4].*Pˢᴳ⁵_2)               # generation cost of strategic SGs 
...
cost_gene_LL=sum(Oᵐ₁[4].* z_Bid_E_g1 )+ sum(Oᵐ₂[4].* z_Bid_E_g2 )+sum(Oᵐ₁[1].*Pˢᴳ²_1+Oᵐ₂[1].*Pˢᴳ²_2)+sum(Oᵐ₁[2].*Pˢᴳ³_1+Oᵐ₂[2].*Pˢᴳ³_2)+sum(Oᵐ₁[3].*Pˢᴳ⁴_1+Oᵐ₂[3].*Pˢᴳ⁴_2)+sum(Oᵐ₁[5].*Pˢᴳ²⁷_1+Oᵐ₂[5].*Pˢᴳ²⁷_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,19].*z_Bid_26_g1 +A[:,20].*z_Bid_29_g1 +A[:,21].*z_Bid_30_g1 + A[:,22].*z_Bid_26_g2 +A[:,23].*z_Bid_29_g2 +A[:,24].*z_Bid_30_g2 )
...
+A[:,16].*yˢᴳ⁴_2 +A[:,17].*yˢᴳ⁴_2 +A[:,18].*yˢᴳ⁴_2 +A[:,25].*yˢᴳ²⁷_1 +A[:,26].*yˢᴳ²⁷_1 +A[:,27].*yˢᴳ²⁷_1 +A[:,28].*yˢᴳ²⁷_2 
