...
kᵐᵐᵃˣ_g=2                                                 # Bidding variable upper bound
...
@variable(model, kᵐ_g1[1:T])          # bidding variable of UL, 2 SGs are strategic let's say
...
@constraint(model,kᵐ_g1.>=1)            # assume there are 2 strategic SGs
