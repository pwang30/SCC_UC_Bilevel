...
@constraint(model, Oⁿˡ[2] +sum( kᴬˢ_26_g1[T]*A[T,7] +kᴬˢ_29_g1[T]*A[T,8] +kᴬˢ_30_g1[T]*A[T,9]) -K_g[3,k]*λ_F[n,T] -Pˢᴳₘₐₓ[2]*μᵐᵃˣˢᴳ³_1[T] +Pˢᴳₘᵢₙ[2]*μᵐⁱⁿˢᴳ³_1[T] +Kˢᵗ[2]*σˢᵗˢᴳ³_1[T] -Kˢʰ[2]*σˢʰˢᴳ³_1[T]+ ψᵐᵃˣˢᴳ³_1[T] >=0)
@constraint(model, Oⁿˡ[2] +sum( kᴬˢ_26_g2[T]*A[T,10] +kᴬˢ_29_g2[T]*A[T,11] +kᴬˢ_30_g2[T]*A[T,12]) -K_g[4,k]*λ_F[n,T] -Pˢᴳₘₐₓ[2]*μᵐᵃˣˢᴳ³_2[T] +Pˢᴳₘᵢₙ[2]*μᵐⁱⁿˢᴳ³_2[T] +Kˢᵗ[2]*σˢᵗˢᴳ³_2[T] -Kˢʰ[2]*σˢʰˢᴳ³_2[T]+ ψᵐᵃˣˢᴳ³_2[T] >=0)
...
for t in 1:T-1                                                                                                                                                       # dual constraints for UC, when t<=T-1
    ...
    @constraint(model, Oⁿˡ[2] +sum( kᴬˢ_26_g1[t]*A[t,7] +kᴬˢ_29_g1[t]*A[t,8] +kᴬˢ_30_g1[t]*A[t,9]) -K_g[3,k]*λ_F[n,t] - Pˢᴳₘₐₓ[2]*μᵐᵃˣˢᴳ³_1[t]+ Pˢᴳₘᵢₙ[2]*μᵐⁱⁿˢᴳ³_1[t]+ Kˢᵗ[2]*(σˢᵗˢᴳ³_1[t]-σˢᵗˢᴳ³_1[t+1])+ Kˢʰ[2]*(σˢᵗˢᴳ³_1[t+1]-σˢᵗˢᴳ³_1[t])+ ψᵐᵃˣˢᴳ³_1[t] >=0)
    @constraint(model, Oⁿˡ[2] +sum( kᴬˢ_26_g2[t]*A[t,10] +kᴬˢ_29_g2[t]*A[t,11] +kᴬˢ_30_g2[t]*A[t,12]) -K_g[4,k]*λ_F[n,t] - Pˢᴳₘₐₓ[2]*μᵐᵃˣˢᴳ³_2[t]+ Pˢᴳₘᵢₙ[2]*μᵐⁱⁿˢᴳ³_2[t]+ Kˢᵗ[2]*(σˢᵗˢᴳ³_2[t]-σˢᵗˢᴳ³_2[t+1])+ Kˢʰ[2]*(σˢᵗˢᴳ³_2[t+1]-σˢᵗˢᴳ³_2[t])+ ψᵐᵃˣˢᴳ³_2[t] >=0)
...
@constraint(model, Oᵐ₁[2]*kᵐ_1[T] -λᴱ[T] +μᵐᵃˣˢᴳ³_1[T] -μᵐⁱⁿˢᴳ³_1[T] +πʳᵘˢᴳ³_1[T] -πʳᵈˢᴳ³_1[T]>=0)
@constraint(model, Oᵐ₂[2]*kᵐ_2[T] -λᴱ[T] +μᵐᵃˣˢᴳ³_2[T] -μᵐⁱⁿˢᴳ³_2[T] +πʳᵘˢᴳ³_2[T] -πʳᵈˢᴳ³_2[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1, assume SGs in bus 2 are strategic
    ...
    @constraint(model, Oᵐ₁[2]*kᵐ_1[t] -λᴱ[t] +μᵐᵃˣˢᴳ³_1[t] -μᵐⁱⁿˢᴳ³_1[t] +πʳᵘˢᴳ³_1[t] -πʳᵘˢᴳ³_1[t+1] -πʳᵈˢᴳ³_1[t] +πʳᵈˢᴳ³_1[t+1]>=0)                
    @constraint(model, Oᵐ₂[2]*kᵐ_2[t] -λᴱ[t] +μᵐᵃˣˢᴳ³_2[t] -μᵐⁱⁿˢᴳ³_2[t] +πʳᵘˢᴳ³_2[t] -πʳᵘˢᴳ³_2[t+1] -πʳᵈˢᴳ³_2[t] +πʳᵈˢᴳ³_2[t+1]>=0)
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g1[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Re_E_g1[t]>=M_λ*Pˢᴳ³_1[t]   +Pˢᴳₘₐₓ[2]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g1[t]<=λᴱ[t]*Pˢᴳₘₐₓ[2])
    @constraint(model, z_Re_E_g1[t]<=M_λ*Pˢᴳ³_1[t]   +Pˢᴳₘᵢₙ[2]*(λᴱ[t]-M_λ)  )
    
    @constraint(model, z_Re_E_g2[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Re_E_g2[t]>=M_λ*Pˢᴳ³_2[t]   +Pˢᴳₘₐₓ[2]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g2[t]<=λᴱ[t]*Pˢᴳₘₐₓ[2])
    @constraint(model, z_Re_E_g2[t]<=M_λ*Pˢᴳ³_2[t]   +Pˢᴳₘᵢₙ[2]*(λᴱ[t]-M_λ)  )

    @constraint(model, z_Bid_E_g1[t]>=Pˢᴳ³_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[2]-Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Bid_E_g1[t]>=kᵐᵐᵃˣ*Pˢᴳ³_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[2]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[2])
    @constraint(model, z_Bid_E_g1[t]<=kᵐᵐᵃˣ*Pˢᴳ³_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[2]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Bid_E_g1[t]<=Pˢᴳ³_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[2]-Pˢᴳₘₐₓ[2])

    @constraint(model, z_Bid_E_g2[t]>=Pˢᴳ³_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[2]-Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Bid_E_g2[t]>=kᵐᵐᵃˣ*Pˢᴳ³_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[2]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[2])
    @constraint(model, z_Bid_E_g2[t]<=kᵐᵐᵃˣ*Pˢᴳ³_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[2]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[2])
    @constraint(model, z_Bid_E_g2[t]<=Pˢᴳ³_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[2]-Pˢᴳₘₐₓ[2])
...
for t in 1:T
    ...
    M_F_29[1,t]=0
    M_F_30[1,t]=kᴬˢᵐᵃˣ*(A[t,9]+A[t,12])+A[t,3]+A[t,6]+A[t,15]+A[t,18]+A[t,21]+A[t,24]+A[t,27]+A[t,30]
end
...
cost_nl_UL=sum(Oⁿˡ[2].*yˢᴳ³_1 ) + sum(Oⁿˡ[2].*yˢᴳ³_2 )                  # no-load cost of strategic SGs
cost_gene_UL=sum(Oᵐ₁[2].*Pˢᴳ³_1) + sum(Oᵐ₂[2].*Pˢᴳ³_2)               # generation cost of strategic SGs 
...
revenue_SCL_UL=0*sum(z_Re_26_g1)+0*sum(z_Re_26_g2)+0*sum(z_Re_29_g1)+0*sum(z_Re_29_g2)+0.067*sum(z_Re_30_g1)+0.065*sum(z_Re_30_g2)                                     # revenue from commit online to offer AS
...
cost_gene_LL=sum(Oᵐ₁[2].* z_Bid_E_g1 )+ sum(Oᵐ₂[2].* z_Bid_E_g2 )+sum(Oᵐ₁[1].*Pˢᴳ²_1+Oᵐ₂[1].*Pˢᴳ²_2)+sum(Oᵐ₁[3].*Pˢᴳ⁴_1+Oᵐ₂[3].*Pˢᴳ⁴_2)+sum(Oᵐ₁[4].*Pˢᴳ⁵_1+Oᵐ₂[4].*Pˢᴳ⁵_2)+sum(Oᵐ₁[5].*Pˢᴳ²⁷_1+Oᵐ₂[5].*Pˢᴳ²⁷_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,7].*z_Bid_26_g1 +A[:,8].*z_Bid_29_g1 +A[:,9].*z_Bid_30_g1 + A[:,10].*z_Bid_26_g2 +A[:,11].*z_Bid_29_g2 +A[:,12].*z_Bid_30_g2 )

cost_AS_non_stra=sum(A[:,1].*yˢᴳ²_1+A[:,2].*yˢᴳ²_1 +A[:,3].*yˢᴳ²_1 +A[:,4].*yˢᴳ²_2 +A[:,5].*yˢᴳ²_2 +A[:,6].*yˢᴳ²_2 +A[:,13].*yˢᴳ⁴_1 
...
matwrite("k_bus_3.mat", Dict("k_bus_3" => kᵐ))

matwrite("energy_prices_bus_3.mat", Dict("energy_prices_bus_3" => λᴱ))

matwrite("SCL_prices_bus_3_26.mat", Dict("SCL_prices_bus_3_26" => λ_F[1,:]))
matwrite("SCL_prices_bus_3_29.mat", Dict("SCL_prices_bus_3_29" => λ_F[2,:]))
matwrite("SCL_prices_bus_3_30.mat", Dict("SCL_prices_bus_3_30" => λ_F[3,:]))

matwrite("I_bus_3_26.mat", Dict("I_bus_3_26" => I_₂₆))
matwrite("I_bus_3_29.mat", Dict("I_bus_3_29" => I_₂₉))
matwrite("I_bus_3_30.mat", Dict("I_bus_3_30" => I_₃₀))

matwrite("reveunes_UL_bus_3.mat", Dict("reveunes_UL_bus_3" => reveunes_UL))
matwrite("costs_UL_bus_3.mat", Dict("costs_UL_bus_3" => costs_UL))
matwrite("profits_UL_bus_3.mat", Dict("profits_UL_bus_3" => obj_UL))

matwrite("profits_bus_3_G2_1.mat", Dict("profits_bus_3_G2_1" => profits_G2_1))
matwrite("profits_bus_3_G2_2.mat", Dict("profits_bus_3_G2_2" => profits_G2_2))
matwrite("profits_bus_3_G4_1.mat", Dict("profits_bus_3_G4_1" => profits_G4_1))
matwrite("profits_bus_3_G4_2.mat", Dict("profits_bus_3_G4_2" => profits_G4_2))
matwrite("profits_bus_3_G5_1.mat", Dict("profits_bus_3_G5_1" => profits_G5_1))
matwrite("profits_bus_3_G5_2.mat", Dict("profits_bus_3_G5_2" => profits_G5_2))
matwrite("profits_bus_3_G27_1.mat", Dict("profits_bus_3_G27_1" => profits_G27_1))
matwrite("profits_bus_3_G27_2.mat", Dict("profits_bus_3_G27_2" => profits_G27_2))
matwrite("profits_bus_3_G30_1.mat", Dict("profits_bus_3_G30_1" => profits_G30_1))
matwrite("profits_bus_3_G30_2.mat", Dict("profits_bus_3_G30_2" => profits_G30_2))
