...
n=1    # for bus 26
k=26
@constraint(model, Oⁿˡ[1] +sum( A[T,1] +A[T,2] +A[T,3]) -K_g[1,k]*λ_F[n,T] -Pˢᴳₘₐₓ[1]*μᵐᵃˣˢᴳ²_1[T] +Pˢᴳₘᵢₙ[1]*μᵐⁱⁿˢᴳ²_1[T] +Kˢᵗ[1]*σˢᵗˢᴳ²_1[T] -Kˢʰ[1]*σˢʰˢᴳ²_1[T]+ ψᵐᵃˣˢᴳ²_1[T] >=0)             # dual constraints for UC, when t==T
...
@constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g1[T]*A[T,25] +kᴬˢ_29_g1[T]*A[T,26] +kᴬˢ_30_g1[T]*A[T,27]) -K_g[9,k]*λ_F[n,T] -Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_1[T] +Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_1[T] +Kˢᵗ[5]*σˢᵗˢᴳ²⁷_1[T] -Kˢʰ[5]*σˢʰˢᴳ²⁷_1[T]+ ψᵐᵃˣˢᴳ²⁷_1[T] >=0)
@constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g2[T]*A[T,28] +kᴬˢ_29_g2[T]*A[T,29] +kᴬˢ_30_g2[T]*A[T,30]) -K_g[10,k]*λ_F[n,T] -Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_2[T] +Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_2[T] +Kˢᵗ[5]*σˢᵗˢᴳ²⁷_2[T] -Kˢʰ[5]*σˢʰˢᴳ²⁷_2[T]+ ψᵐᵃˣˢᴳ²⁷_2[T] >=0)
...
for t in 1:T-1                                                                                                                                                       # dual constraints for UC, when t<=T-1
    @constraint(model, Oⁿˡ[1] +sum( A[t,1] +A[t,2] +A[t,3]) -K_g[1,k]*λ_F[n,t] - Pˢᴳₘₐₓ[1]*μᵐᵃˣˢᴳ²_1[t]+ Pˢᴳₘᵢₙ[1]*μᵐⁱⁿˢᴳ²_1[t]+ Kˢᵗ[1]*(σˢᵗˢᴳ²_1[t]-σˢᵗˢᴳ²_1[t+1])+ Kˢʰ[1]*(σˢᵗˢᴳ²_1[t+1]-σˢᵗˢᴳ²_1[t])+ ψᵐᵃˣˢᴳ²_1[t] >=0)                
    ...
    @constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g1[t]*A[t,25] +kᴬˢ_29_g1[t]*A[t,26] +kᴬˢ_30_g1[t]*A[t,27]) -K_g[9,k]*λ_F[n,t] - Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_1[t]+ Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_1[t]+ Kˢᵗ[5]*(σˢᵗˢᴳ²⁷_1[t]-σˢᵗˢᴳ²⁷_1[t+1])+ Kˢʰ[5]*(σˢᵗˢᴳ²⁷_1[t+1]-σˢᵗˢᴳ²⁷_1[t])+ ψᵐᵃˣˢᴳ²⁷_1[t] >=0)
    @constraint(model, Oⁿˡ[5] +sum( kᴬˢ_26_g2[t]*A[t,28] +kᴬˢ_29_g2[t]*A[t,29] +kᴬˢ_30_g2[t]*A[t,30]) -K_g[10,k]*λ_F[n,t] - Pˢᴳₘₐₓ[5]*μᵐᵃˣˢᴳ²⁷_2[t]+ Pˢᴳₘᵢₙ[5]*μᵐⁱⁿˢᴳ²⁷_2[t]+ Kˢᵗ[5]*(σˢᵗˢᴳ²⁷_2[t]-σˢᵗˢᴳ²⁷_2[t+1])+ Kˢʰ[5]*(σˢᵗˢᴳ²⁷_2[t+1]-σˢᵗˢᴳ²⁷_2[t])+ ψᵐᵃˣˢᴳ²⁷_2[t] >=0)
...
@constraint(model, Oᵐ₁[5]*kᵐ_1[T] -λᴱ[T] +μᵐᵃˣˢᴳ²⁷_1[T] -μᵐⁱⁿˢᴳ²⁷_1[T] +πʳᵘˢᴳ²⁷_1[T] -πʳᵈˢᴳ²⁷_1[T]>=0)
@constraint(model, Oᵐ₂[5]*kᵐ_2[T] -λᴱ[T] +μᵐᵃˣˢᴳ²⁷_2[T] -μᵐⁱⁿˢᴳ²⁷_2[T] +πʳᵘˢᴳ²⁷_2[T] -πʳᵈˢᴳ²⁷_2[T]>=0)
...
for t in 1:T-1                                                                                                  # dual constraints for generation, when t<=T-1, assume SGs in bus 2 are strategic
    ...
    @constraint(model, Oᵐ₁[5]*kᵐ_1[t] -λᴱ[t] +μᵐᵃˣˢᴳ²⁷_1[t] -μᵐⁱⁿˢᴳ²⁷_1[t] +πʳᵘˢᴳ²⁷_1[t] -πʳᵘˢᴳ²⁷_1[t+1] -πʳᵈˢᴳ²⁷_1[t] +πʳᵈˢᴳ²⁷_1[t+1]>=0)
    @constraint(model, Oᵐ₂[5]*kᵐ_2[t] -λᴱ[t] +μᵐᵃˣˢᴳ²⁷_2[t] -μᵐⁱⁿˢᴳ²⁷_2[t] +πʳᵘˢᴳ²⁷_2[t] -πʳᵘˢᴳ²⁷_2[t+1] -πʳᵈˢᴳ²⁷_2[t] +πʳᵈˢᴳ²⁷_2[t+1]>=0)
...
for t in 1:T
    ...
    @constraint(model, z_Re_E_g1[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Re_E_g1[t]>=M_λ*Pˢᴳ²⁷_1[t]   +Pˢᴳₘₐₓ[5]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g1[t]<=λᴱ[t]*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Re_E_g1[t]<=M_λ*Pˢᴳ²⁷_1[t]   +Pˢᴳₘᵢₙ[5]*(λᴱ[t]-M_λ)  )
    
    @constraint(model, z_Re_E_g2[t]>=λᴱ[t]*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Re_E_g2[t]>=M_λ*Pˢᴳ²⁷_2[t]   +Pˢᴳₘₐₓ[5]*(λᴱ[t]-M_λ) )
    @constraint(model, z_Re_E_g2[t]<=λᴱ[t]*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Re_E_g2[t]<=M_λ*Pˢᴳ²⁷_2[t]   +Pˢᴳₘᵢₙ[5]*(λᴱ[t]-M_λ)  )

    @constraint(model, z_Bid_E_g1[t]>=Pˢᴳ²⁷_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[5]-Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g1[t]>=kᵐᵐᵃˣ*Pˢᴳ²⁷_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[5]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Bid_E_g1[t]<=kᵐᵐᵃˣ*Pˢᴳ²⁷_1[t]+kᵐ_1[t]*Pˢᴳₘᵢₙ[5]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g1[t]<=Pˢᴳ²⁷_1[t]+kᵐ_1[t]*Pˢᴳₘₐₓ[5]-Pˢᴳₘₐₓ[5])

    @constraint(model, z_Bid_E_g2[t]>=Pˢᴳ²⁷_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[5]-Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g2[t]>=kᵐᵐᵃˣ*Pˢᴳ²⁷_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[5]-kᵐᵐᵃˣ*Pˢᴳₘₐₓ[5])
    @constraint(model, z_Bid_E_g2[t]<=kᵐᵐᵃˣ*Pˢᴳ²⁷_2[t]+kᵐ_2[t]*Pˢᴳₘᵢₙ[5]-kᵐᵐᵃˣ*Pˢᴳₘᵢₙ[5])
    @constraint(model, z_Bid_E_g2[t]<=Pˢᴳ²⁷_2[t]+kᵐ_2[t]*Pˢᴳₘₐₓ[5]-Pˢᴳₘₐₓ[5])
...
cost_nl_UL=sum(Oⁿˡ[5].*yˢᴳ²⁷_1 ) + sum(Oⁿˡ[5].*yˢᴳ²⁷_2 )                  # no-load cost of strategic SGs
cost_gene_UL=sum(Oᵐ₁[5].*Pˢᴳ²⁷_1) + sum(Oᵐ₂[5].*Pˢᴳ²⁷_2)               # generation cost of strategic SGs 
...
cost_gene_LL=sum(Oᵐ₁[5].* z_Bid_E_g1 )+ sum(Oᵐ₂[5].* z_Bid_E_g2 )+sum(Oᵐ₁[1].*Pˢᴳ²_1+Oᵐ₂[1].*Pˢᴳ²_2)+sum(Oᵐ₁[2].*Pˢᴳ³_1+Oᵐ₂[2].*Pˢᴳ³_2)+sum(Oᵐ₁[3].*Pˢᴳ⁴_1+Oᵐ₂[3].*Pˢᴳ⁴_2)+sum(Oᵐ₁[4].*Pˢᴳ⁵_1+Oᵐ₂[4].*Pˢᴳ⁵_2)+sum(Oᵐ₁[6].*Pˢᴳ³⁰_1+Oᵐ₂[6].*Pˢᴳ³⁰_2)   
cost_IBR_LL=sum(Oᴱ_c[1].*Pᴵᴮᴳ¹) +sum(Oᴱ_c[2].*Pᴵᴮᴳ²³) +sum(Oᴱ_c[3].*Pᴵᴮᴳ²⁶)

cost_AS_stra= sum(A[:,25].*z_Bid_26_g1 +A[:,26].*z_Bid_29_g1 +A[:,27].*z_Bid_30_g1 + A[:,28].*z_Bid_26_g2 +A[:,29].*z_Bid_29_g2 +A[:,30].*z_Bid_30_g2 )

cost_AS_non_stra=sum(A[:,1].*yˢᴳ²_1+A[:,2].*yˢᴳ²_1 +A[:,3].*yˢᴳ²_1 +A[:,4].*yˢᴳ²_2 +A[:,5].*yˢᴳ²_2 +A[:,6].*yˢᴳ²_2 +A[:,7].*yˢᴳ³_1 
+A[:,8].*yˢᴳ³_1 +A[:,9].*yˢᴳ³_1 +A[:,10].*yˢᴳ³_2 +A[:,11].*yˢᴳ³_2 +A[:,12].*yˢᴳ³_2 +A[:,13].*yˢᴳ⁴_1 +A[:,14].*yˢᴳ⁴_1 +A[:,15].*yˢᴳ⁴_1 
+A[:,16].*yˢᴳ⁴_2 +A[:,17].*yˢᴳ⁴_2 +A[:,18].*yˢᴳ⁴_2 +A[:,19].*yˢᴳ⁵_1 +A[:,20].*yˢᴳ⁵_1 +A[:,21].*yˢᴳ⁵_1 +A[:,22].*yˢᴳ⁵_2 
+A[:,23].*yˢᴳ⁵_2 +A[:,24].*yˢᴳ⁵_2+A[:,31].*yˢᴳ³⁰_1 +A[:,32].*yˢᴳ³⁰_1 +A[:,33].*yˢᴳ³⁰_1 +A[:,34].*yˢᴳ³⁰_2 +A[:,35].*yˢᴳ³⁰_2 +A[:,36].*yˢᴳ³⁰_2)
...
profits_G3_1=revenue_energy_G3_1+revenue_SCL_G3_1-cost_nl_G3_1-cost_gene_G3_1-cost_onoff_G3_1
...
profits_G3_2=revenue_energy_G3_2+revenue_SCL_G3_2-cost_nl_G3_2-cost_gene_G3_2-cost_onoff_G3_2
...
profits_G2_1=revenue_energy_G2_1+revenue_SCL_G2_1-cost_nl_G2_1-cost_gene_G2_1-cost_onoff_G2_1
...
profits_G2_2=revenue_energy_G2_2+revenue_SCL_G2_2-cost_nl_G2_2-cost_gene_G2_2-cost_onoff_G2_2
...
profits_G4_1=revenue_energy_G4_1+revenue_SCL_G4_1-cost_nl_G4_1-cost_gene_G4_1-cost_onoff_G4_1
...
profits_G4_2=revenue_energy_G4_2+revenue_SCL_G4_2-cost_nl_G4_2-cost_gene_G4_2-cost_onoff_G4_2
...
profits_G5_1=revenue_energy_G5_1+revenue_SCL_G5_1-cost_nl_G5_1-cost_gene_G5_1-cost_onoff_G5_1
...
profits_G5_2=revenue_energy_G5_2+revenue_SCL_G5_2-cost_nl_G5_2-cost_gene_G5_2-cost_onoff_G5_2
...
profits_G30_1=revenue_energy_G30_1+revenue_SCL_G30_1-cost_nl_G30_1-cost_gene_G30_1-cost_onoff_G30_1
...
profits_G30_2=revenue_energy_G30_2+revenue_SCL_G30_2-cost_nl_G30_2-cost_gene_G30_2-cost_onoff_G30_2


matwrite("k_bus_27.mat", Dict("k_bus_27" => kᵐ))

matwrite("energy_prices_bus_27.mat", Dict("energy_prices_bus_27" => λᴱ))

matwrite("SCL_prices_bus_27_26.mat", Dict("SCL_prices_bus_27_26" => λ_F[1,:]))
matwrite("SCL_prices_bus_27_29.mat", Dict("SCL_prices_bus_27_29" => λ_F[2,:]))
matwrite("SCL_prices_bus_27_30.mat", Dict("SCL_prices_bus_27_30" => λ_F[3,:]))

matwrite("I_bus_27_26.mat", Dict("I_bus_27_26" => I_₂₆))
matwrite("I_bus_27_29.mat", Dict("I_bus_27_29" => I_₂₉))
matwrite("I_bus_27_30.mat", Dict("I_bus_27_30" => I_₃₀))

matwrite("reveunes_UL_bus_27.mat", Dict("reveunes_UL_bus_27" => reveunes_UL))
matwrite("costs_UL_bus_27.mat", Dict("costs_UL_bus_27" => costs_UL))
matwrite("profits_UL_bus_27.mat", Dict("profits_UL_bus_27" => obj_UL))

matwrite("profits_bus_27_G3_1.mat", Dict("profits_bus_27_G3_1" => profits_G3_1))
matwrite("profits_bus_27_G3_2.mat", Dict("profits_bus_27_G3_2" => profits_G3_2))
matwrite("profits_bus_27_G2_1.mat", Dict("profits_bus_27_G2_1" => profits_G2_1))
matwrite("profits_bus_27_G2_2.mat", Dict("profits_bus_27_G2_2" => profits_G2_2))
matwrite("profits_bus_27_G4_1.mat", Dict("profits_bus_27_G4_1" => profits_G4_1))
matwrite("profits_bus_27_G4_2.mat", Dict("profits_bus_27_G4_2" => profits_G4_2))
matwrite("profits_bus_27_G5_1.mat", Dict("profits_bus_27_G5_1" => profits_G5_1))
matwrite("profits_bus_27_G5_2.mat", Dict("profits_bus_27_G5_2" => profits_G5_2))
matwrite("profits_bus_27_G30_1.mat", Dict("profits_bus_27_G30_1" => profits_G30_1))
matwrite("profits_bus_27_G30_2.mat", Dict("profits_bus_27_G30_2" => profits_G30_2))
