...
df = DataFrame(CSV.File("C:/Users/ME2/Desktop/single_level_UC_SCL_marginalprice/Loadcurves.csv"))        
loadcurve=df[:,:]  
df = DataFrame(CSV.File( "C:/Users/ME2/Desktop/single_level_UC_SCL_marginalprice/Windcurves.csv") ) 
windcurves=df[:,:]
